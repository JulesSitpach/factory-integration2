  ...
  return (
    <div className="space-y-8">
      ...
      <div className="border-b pb-4">
        <h1 className="text-2xl font-bold">Emergency Cost Calculator</h1>
        <p className="text-gray-600 mt-1">
          Calculate potential savings on import tariffs and landed costs.
        </p>
      </div>
      ...
      <div className="bg-white rounded-lg shadow p-6">
        ...
        <div className="space-y-4">
          ...
          <div className="flex justify-end space-x-3">
            ...
            >
              {isUploading ? 'Uploading...' : 'Upload and Calculate'}
            </button>
          </div>
        </div>
      </div>
      ...
      {calculationResult && (
        <div className="bg-white rounded-lg shadow p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
            ...
            <div className="bg-gray-50 p-4 rounded-lg">
              <h3 className="text-sm font-medium mb-3">Tariff by Country</h3>
              <div className="h-64">
          ...
          <div className="mt-8">
            <h3 className="text-md font-medium mb-3">Alternative Suppliers</h3>
                    ...
                    detail.alternative_suppliers.length > 0 && (
                      ...
                      >
                        ...
                        <p className="text-xs text-gray-500 mb-2">
                          Current Supplier: {detail.country_of_origin} (
                          {formatPercentage(detail.tariff_rate)})
                        </p>
          ...
          <div className="mt-6 text-xs text-gray-500 text-right">
            Calculated on: {formatDate(calculationResult.created_at)}
            <br />
            Calculation ID: {calculationResult.id}
          </div>
        </div>
      )}
    </div>
